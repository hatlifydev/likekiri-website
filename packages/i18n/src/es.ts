...
export const es = {
  ...
  home: {
    ...
    s2ConsumoD: 'Un modelo pequeño en hardware modesto cuando alcanza; uno de un gran proveedor cuando aporta de verdad. El criterio es tu costo total de operación, no la moda.',
